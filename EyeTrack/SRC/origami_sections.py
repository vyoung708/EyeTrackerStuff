...
#     
#     invVol1 = [vol11, inv11, vol21, inv21, vol31, inv31, vol41, inv41, vol51, inv51, vol61, inv61, vol71, inv71]
#     
...
#     
#     invVol2 = [vol12, inv12, vol22, inv22, vol32, inv32, vol42, inv42, vol52, inv52, vol62, inv62, vol72, inv72]
#     
...
#     
#     invVol3 = [vol13, inv13, vol23, inv23, vol33, inv33, vol43, inv43, vol53, inv53, vol63, inv63, vol73, inv73]
# 
# #     x = np.arange(1, 15)
# #     plt.figure()
...
#     x = np.arange(1, 8)
#     
#     length11 = vol11 / (origami11[-1, 0] - origami11[0, 0])
